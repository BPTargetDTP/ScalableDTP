...
class DDTPConvNetworkCIFAR(DDTPConvNetwork):
    ...
    # NOTE: Using a class variable, as a hacky way to change this without adding a command-line arg.
    pool_padding: ClassVar[int] = 1
    ...
    def __init__(self, bias=True, hidden_activation='tanh',
        ...
        l2 = DDTPConvLayer(32, 64, (5, 5), output_size=10,
                           ...
                           feedback_activation=feedback_activation,
                           nb_feedback_iterations = nb_feedback_iterations[1])
        l3 = DDTPMLPLayer(in_features=(8 * 8 * 64 if type(self).pool_padding == 1 else 7 * 7 * 64),

...
class DTP(LightningModule, Model):
    ...
    This is (as far as I know) exactly equivalent with @anonymous's implementation.
    ...
    In other words, to reproduce @anonymous's results on Cifar-10, there is no need to change
    ...
    def forward_loss(self, x: Tensor, y: Tensor, phase: str) -> Dict[str, Union[Tensor, Any]]:
        ...
        with torch.no_grad():
            for i in reversed(range(1, N)):
                ...
                # NOTE: Shifted the indices by 1 compared to @anonymous's eq.
